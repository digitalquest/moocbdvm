...
[[http://andsens.github.io/bootstrap-vz/][bootstrap-vz]] pour l'installation du système Debian de base (cf. [[https://github.com/olberger/DebianJessieBaseBox]]), complétée
par des scripts de /provisionning/ que nous avons développés
(disponibles sur [[https://fusionforge.int-evry.fr/plugins/scmgit/cgi-bin/gitweb.cgi?p=moocbdvm/moocbdvm.git;a=tree;f=VagrantBox/Provisionning;hb=HEAD]])
